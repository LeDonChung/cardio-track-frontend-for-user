...
export const OrderPage = () => {
    ...
    const handleQuantityChange = (index, type) => {
        ...
        const newQuantity = type === 'increase' ? updatedProducts[index].quantity + 1 : updatedProducts[index].quantity - 1;
        updatedProducts[index].quantity = newQuantity >= 1 ? newQuantity : 1;
    ...
    const handleSelectAll = () => {
        ...
        // Cập nhật selected cho tất cả sản phẩm
    ...
    const handleSelectProduct = (index) => {
        ...
        // Kiểm tra xem còn sản phẩm nào chưa được chọn không
    ...
    const totalPrice = selectedProducts.reduce((total, product) => total + (product.selected ? product.quantity * product.price : 0), 0);
                                    ...
                                    {selectedProducts.map((product, index) => (
                                        <tr key={index} className="border-b">
                                            <td className="py-4 px-4 flex items-center">
                                                ...
                                                />
                                                <img src={product.image} alt={`Image of ${product.name}`} className="ml-4 w-12 h-12 object-cover"/>
                                                <span className="ml-4">{product.name}</span>
                                            </td>
                                            <td className="py-4 px-4 text-blue-600">{product.price.toLocaleString()}đ</td>
                                            <td className="py-4 px-4 flex items-center">
                                                <button 
                                            ...
                                            <td>
                                                <button className="mr-4 ml-4 text-gray-600 hover:text-gray-800">
                    ...
                    <div className="p-4 rounded-md w-1/3">
                        <div className="bg-white p-4 rounded-md border shadow-md">
                            ...
                            <div className="flex justify-between py-2">
                                ...
                                <span className="text-blue-600">0đ</span>
                            </div>
                            ...
                            <div className="flex justify-between py-2">
                                ...
                                <span className="text-blue-600 font-bold">{totalPrice.toLocaleString()}đ</span>
                            </div>    
